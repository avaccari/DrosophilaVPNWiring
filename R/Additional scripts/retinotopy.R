...
# ******************************
# For retinotopy consider the distances between all possible pairs in lobula 
# and in glomerulus (pre.coordinates)

# Mutual correlation for the distances?
#
# Things that are close in the lobula (dendrites endpoints - centroids) are 
# close in the glomerulus (centroid of the pre.synapses of the same body ID).

# No posts in this analysis.

# Create a table with each of the 71 LC4 (and for the other VPN)
# plot with x-distance in the glomerulus, y-distance in the lobula for every pair
# 2x71x71 correlation matrices one for lobula and one for glomerulus to show if
# there is a correlation.

# LC12 is the negative control (new plane).

# Make a function where you pass the name of the VPN and you get back the planes
# separating lobula from glomerulus.

# Normalization because of shape???? (Maybe use mutual information instead of
# correlation).
